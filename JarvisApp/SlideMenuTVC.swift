...
class SlideMenuTVC: UITableViewController {
    ...
    func allUI()
    {
        ...
        oneButton.addTarget(self, action: #selector(SlideMenuTVC.oneButtonClick(_:)), forControlEvents: .TouchDown)
        ...
        twoButton.addTarget(self, action: #selector(SlideMenuTVC.twoButtonClick(_:)), forControlEvents: .TouchDown)
        ...
        threeButton.addTarget(self, action: #selector(SlideMenuTVC.threeButtonClick(_:)), forControlEvents: .TouchDown)
        ...
        fourButton.addTarget(self, action: #selector(SlideMenuTVC.fourButtonClick(_:)), forControlEvents: .TouchDown)
