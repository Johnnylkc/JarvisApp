...
class SecondTVC: UITableViewController , UITextViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    func allUI()
    {
        ...
        hamburgerButton.addTarget(self, action: #selector(SecondTVC.showSideMenu(_:)), forControlEvents: .TouchUpInside)
        ...
        cameraButton.addTarget(self, action: #selector(SecondTVC.showCamera(_:)), forControlEvents: .TouchUpInside)
